...
struct Scalar
{
    ...
    MIN_HEADER_EXPORT static Scalar known_derivatives(PassiveT _val, const GradType& _grad, const HessType& _Hess)
    {
        Scalar res;
        res.val = _val;
        res.grad = _grad;
    ...
    MIN_HEADER_EXPORT static Scalar known_derivatives(PassiveT _val, PassiveT _grad, PassiveT _Hess)
    {
    ...
    MIN_HEADER_EXPORT static Scalar make_passive(PassiveT _val, Eigen::Index _k_dynamic)
    {
    ...
    MIN_HEADER_EXPORT static Scalar make_active(PassiveT _val, Eigen::Index _idx, Eigen::Index _k_dynamic)
    {
        if constexpr (!dynamic_mode_)
    ...
    MIN_HEADER_EXPORT static Eigen::Matrix<Scalar, k, 1> make_active(
    ...
    MIN_HEADER_EXPORT static Scalar chain(
    ...
    MIN_HEADER_EXPORT friend Scalar operator-(
            const Scalar& a)
    {
    ...
    MIN_HEADER_EXPORT friend Scalar sqrt(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar sqr(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar pow(
            const Scalar& a,
            const int& e)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
    ...
    MIN_HEADER_EXPORT friend Scalar fabs(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar abs(
            const Scalar& a)
    {
        return fabs(a);
    }

    MIN_HEADER_EXPORT friend Scalar exp(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar log(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar log2(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar log10(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar sin(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar cos(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar tan(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar asin(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar acos(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
    ...
    MIN_HEADER_EXPORT friend Scalar atan(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar sinh(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar cosh(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar tanh(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar asinh(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar acosh(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar atanh(
            const Scalar& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend bool isnan(
            const Scalar& a)
    {
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend bool isinf(
            const Scalar& a)
    {
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend bool isfinite(
            const Scalar& a)
    {
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT Scalar& operator+=(
            const Scalar& b)
    {
...
//        }
    ...
    MIN_HEADER_EXPORT friend Scalar atan2(
            const Scalar& y,
            const Scalar& x)
    {
    ...
    MIN_HEADER_EXPORT friend Scalar hypot(
            const Scalar& a,
            const Scalar& b)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
    ...
    MIN_HEADER_EXPORT friend bool operator==(
            const Scalar& a,
            const Scalar& b)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
    ...
    MIN_HEADER_EXPORT friend Scalar min(
            const Scalar& a,
            const Scalar& b)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
    ...
    MIN_HEADER_EXPORT friend Scalar fmin(
            const Scalar& a,
            const Scalar& b)
    {
        return min(a, b);
    ...
    MIN_HEADER_EXPORT friend Scalar max(
            const Scalar& a,
            const Scalar& b)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
    ...
    MIN_HEADER_EXPORT friend Scalar fmax(
            const Scalar& a,
            const Scalar& b)
    {
        return max(a, b);
    ...
    MIN_HEADER_EXPORT friend Scalar clamp(
            const Scalar& x,
            const Scalar& a,
            const Scalar& b)
    {
    ...
    MIN_HEADER_EXPORT friend std::complex<Scalar> operator+(
    ...
    MIN_HEADER_EXPORT friend std::complex<Scalar> sqr(
            const std::complex<Scalar>& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend std::complex<Scalar> conj(
            const std::complex<Scalar>& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend Scalar arg(
            const std::complex<Scalar>& a)
    {
        TINYAD_CHECK_FINITE_IF_ENABLED_AD(a);
        if constexpr (TINYAD_ENABLE_OPERATOR_LOGGING) TINYAD_DEBUG_VAR(__FUNCTION__);
    ...
    MIN_HEADER_EXPORT friend std::ostream& operator<<(
            std::ostream& s,
            const Scalar& a)
    {
        s << a.val << std::endl;
